...
[here](https://github.com/3dwardCh3nG/pi-cluster-k8s-helm-charts/issues/new?assignees=3dwardCh3nG&labels=bug&template=bug_report.yaml&name=homer&version=0.1.0)**
...
```console
helm install homer oci://ghcr.io/3dwardCh3nG/pi-cluster-k8s-helm-charts/homer
```
